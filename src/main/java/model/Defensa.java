...
public class Defensa extends Jugador {
    ...
    private int entradas;
     ...
     // Constructor
     public Defensa (int idEquipo, int numero, String nombre, int añosEnEquipo, int partidosJugados, int cantidadGoles, int asistencias, double promedioGoles, int entradas, int bloqueos) {
